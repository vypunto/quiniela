      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 h-[58px] flex items-center gap-2 sm:gap-3">
        ...
        {activeTab === 'publicaciones' && viewMode !== 'week' && (
          <div className="hidden sm:flex items-center gap-1.5">
            ...
            <span className="font-black tracking-tight text-gray-900 text-sm min-w-[130px] text-center">{MONTHS_ES[month]} {year}</span>
        ...
        <div className="sm:hidden flex items-center justify-between px-3 pb-2 gap-2">
          {viewMode !== 'week' && (
            <div className="flex items-center gap-1">
              <button onClick={onPrev} className="w-8 h-8 rounded-xl border border-gray-200 flex items-center justify-center text-gray-600 active:bg-gray-100">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M9 11L5 7l4-4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
              </button>
              <span className="font-black tracking-tight text-gray-900 text-sm px-2">{MONTHS_ES[month]} {year}</span>
              <button onClick={onNext} className="w-8 h-8 rounded-xl border border-gray-200 flex items-center justify-center text-gray-600 active:bg-gray-100">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M5 3l4 4-4 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
              </button>
            </div>
          )}
