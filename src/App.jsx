...
const DEMO = [
  ...
  { id: 'd5',  proyecto: 'GASTRO LEAGUE',       fecha: new Date(Y,M,15), titulo: 'Menú especial de temporada: sabores de verano', copy: 'Tomate de huerta, gazpacho de la abuela y nuestro arroz caldoso de bogavante. 🦞🍅', media: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=900&q=80', tipo: 'imagen', canal: 'Instagram', estado: '' },
  ...
  { id: 'd9',  proyecto: 'GASTRO LEAGUE',       fecha: new Date(Y,M,9),  titulo: 'El postre del mes: tarta de queso con membrillo', copy: 'Nuestra tarta de queso con membrillo casero se ha convertido en la más pedida del mes. 🧀', media: 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=900&q=80', tipo: 'imagen', canal: 'Instagram', estado: '' },
  ...
  { id: 'n13', proyecto: 'GLOBALY LIVE',        fecha: new Date(Y,M,29), titulo: 'El público que nos hace grandes', copy: '3.000 personas que lo dieron todo. Esto es por vosotros 🔥🎤', media: 'https://images.unsplash.com/photo-1524368535928-5b5e00ddc76b?w=900&q=80', tipo: 'imagen', canal: 'Instagram', estado: '' },

  // ── Vídeos ──
  { id: 'd3',  proyecto: 'GLOBALY LIVE',        fecha: new Date(Y,M,9),  titulo: 'Concierto en directo este sábado — entrada libre', copy: '🎵 Este sábado música en vivo desde las 20h. Acceso libre hasta completar aforo.', media: 'https://www.youtube.com/watch?v=ZbZSe6N_BXs', tipo: 'video', canal: 'TikTok', estado: '' },
  ...
  { id: 'd11', proyecto: 'GLOBALY LIVE',        fecha: new Date(Y,M,20), titulo: 'Recap del concierto del sábado 🔥', copy: 'Qué noche más especial. Gracias a todos los que vinisteis. ❤️🎶', media: 'https://www.youtube.com/watch?v=09R8_2nJtjg', tipo: 'video', canal: 'TikTok', estado: '' },
  { id: 'n8',  proyecto: 'GASTRO LEAGUE',       fecha: new Date(Y,M,5),  titulo: 'Vídeo: Así elaboramos nuestro pan de masa madre', copy: '72 horas de fermentación. No hay atajos para el sabor real 🍞🔥', media: 'https://www.youtube.com/watch?v=kJQP7kiw5Fk', tipo: 'video', canal: 'TikTok', estado: '' },
  ...
  { id: 'n1',  proyecto: 'PREVENIDOS Y ACCION', fecha: new Date(Y,M,6),  titulo: 'Reel: RCP en 4 pasos — guarda este vídeo', copy: 'Comparte. Puede salvar una vida 🚨 Solo necesitas saber esto.', media: 'https://www.youtube.com/watch?v=fJ9rUzIMcZQ', tipo: 'reel', canal: 'TikTok', estado: '' },
  ...
  { id: 'd10', proyecto: 'GASTRO LEAGUE',       fecha: new Date(Y,M,13), titulo: 'Reel: El plato del día en tiempo récord', copy: 'Mira cómo montamos un pulpo a la gallega en 45 segundos 🐙⚡', media: 'https://www.youtube.com/watch?v=3AAdKl1UYZs', tipo: 'reel', canal: 'TikTok', estado: '' },
  ...
  { id: 'n6',  proyecto: 'GASTRO LEAGUE',       fecha: new Date(Y,M,21), titulo: 'Carrusel: Los 5 platos del mes de agosto', copy: 'Agosto sabe así 🌞 Nuestras propuestas favoritas. ¿Cuál es la tuya?', media: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=900&q=80, https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=900&q=80, https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=900&q=80, https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=900&q=80, https://images.unsplash.com/photo-1540189549336-e6e99eb4b45f?w=900&q=80', tipo: 'carrusel', canal: 'LinkedIn', estado: '' },
  { id: 'n7',  proyecto: 'GLOBALY LIVE',        fecha: new Date(Y,M,28), titulo: 'Carrusel: 12 momentos del mes', copy: '12 momentos, 12 fotos, 1 mes que no olvidaremos 📸 Desliza hasta el final 👉', media: 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=900&q=80, https://images.unsplash.com/photo-1524368535928-5b5e00ddc76b?w=900&q=80, https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=900&q=80, https://images.unsplash.com/photo-1429514513361-8fa32282fd5f?w=900&q=80', tipo: 'carrusel', canal: 'Instagram', estado: '' },
  ...
  // ── Historias ──
  { id: 'h0',  proyecto: 'GASTRO LEAGUE',       fecha: new Date(Y,M,4),  titulo: 'Historia: Especial del día — pulpo a la gallega', copy: '¡Solo hasta las 16h! Ven antes de que se acabe 🐙', media: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=900&q=80', tipo: 'historia', canal: 'Instagram', estado: '' },
  ...
  { id: 'h2',  proyecto: 'GLOBALY LIVE',        fecha: new Date(Y,M,9),  titulo: 'Historia: Soundcheck en directo ahora mismo', copy: 'Estamos preparando algo especial para esta noche 🎶 Os vemos pronto.', media: 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=900&q=80', tipo: 'historia', canal: 'Instagram', estado: '' },
  ...
  // ── GASTRO LEAGUE multi-canal (LinkedIn + Facebook + Web) ──
  { id: 'gl1', proyecto: 'GASTRO LEAGUE', fecha: new Date(Y,M,6),  titulo: 'Cocina de kilómetro cero: nuestra filosofía de producto', copy: 'Trabajamos con más de 30 productores locales. En este artículo te contamos por qué apostamos por el producto de proximidad y cómo elegimos a cada proveedor.', media: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=900&q=80', tipo: 'texto', canal: 'LinkedIn', estado: '' },
  { id: 'gl2', proyecto: 'GASTRO LEAGUE', fecha: new Date(Y,M,11), titulo: 'Premio a la mejor carta de temporada 2026', copy: 'Estamos muy orgullosos de anunciar que Gastro League ha recibido el premio a la mejor carta de temporada en los Premios Gastronómicos del Mediterráneo. Gracias a todo el equipo y a vosotros. 🏆', media: 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=900&q=80', tipo: 'imagen', canal: 'LinkedIn', estado: '' },
  { id: 'gl3', proyecto: 'GASTRO LEAGUE', fecha: new Date(Y,M,3),  titulo: '¡Especial fin de semana! Brunch hasta las 16h', copy: 'Ven a disfrutar de nuestro brunch de fin de semana. Mesa para dos desde 18€ por persona. ¡Reserva ya en el enlace de la bio! 🍳☕', media: 'https://images.unsplash.com/photo-1533089860892-a7c6f0a88666?w=900&q=80', tipo: 'imagen', canal: 'Facebook', estado: '' },
  { id: 'gl4', proyecto: 'GASTRO LEAGUE', fecha: new Date(Y,M,18), titulo: 'Menú del día — semana del 18 al 24', copy: 'Compartimos el menú completo de esta semana. Primer plato, segundo y postre casero por 14,50€. Llámanos para reservar tu mesa ☎️', media: 'https://images.unsplash.com/photo-1540189549336-e6e99eb4b45f?w=900&q=80', tipo: 'imagen', canal: 'Facebook', estado: '' },
  { id: 'gl5', proyecto: 'GASTRO LEAGUE', fecha: new Date(Y,M,8),  titulo: 'Receta: Gazpacho andaluz con crujiente de jamón', copy: 'Esta semana publicamos en el blog la receta completa de nuestro gazpacho estrella. Con los trucos del chef y todos los pasos detallados. ¿Te atreves a hacerlo en casa?', media: 'https://images.unsplash.com/photo-1476718406336-bb5a9690ee2a?w=900&q=80', tipo: 'texto', canal: 'Web', estado: '' },
  { id: 'gl6', proyecto: 'GASTRO LEAGUE', fecha: new Date(Y,M,22), titulo: 'Guía de maridaje: vinos y platos de temporada', copy: 'Hemos preparado una guía completa de maridaje para los platos estrella de verano. Descubre qué vino acompaña mejor a cada propuesta gastronómica de nuestra carta actual.', media: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=900&q=80', tipo: 'texto', canal: 'Web', estado: '' },

  // ── GLOBALY LIVE multi-canal (LinkedIn + Facebook) ──
  { id: 'gv1', proyecto: 'GLOBALY LIVE', fecha: new Date(Y,M,4),  titulo: 'Cómo producimos un festival de 3.000 personas: detrás del escenario', copy: 'Producir un evento de estas dimensiones requiere más de 6 meses de planificación, 120 personas en equipo y una logística milimétrica. Compartimos el proceso completo.', media: 'https://images.unsplash.com/photo-1429514513361-8fa32282fd5f?w=900&q=80', tipo: 'texto', canal: 'LinkedIn', estado: '' },
  { id: 'gv2', proyecto: 'GLOBALY LIVE', fecha: new Date(Y,M,14), titulo: 'Globaly Live incorpora tecnología de sonido inmersivo en sus eventos', copy: 'Somos el primer promotor en España en implantar sistemas de audio 360° en espacios al aire libre. Un paso más en nuestra apuesta por la experiencia del espectador.', media: 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=900&q=80', tipo: 'imagen', canal: 'LinkedIn', estado: '' },
  { id: 'gv3', proyecto: 'GLOBALY LIVE', fecha: new Date(Y,M,7),  titulo: 'Entradas a mitad de precio — solo este fin de semana', copy: '¡Flash sale! Hasta el domingo tienes las entradas al 50% para nuestro próximo concierto. Corre que se agotan. 🎟️🔥 Enlace en los comentarios.', media: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=900&q=80', tipo: 'imagen', canal: 'Facebook', estado: '' },
  { id: 'gv4', proyecto: 'GLOBALY LIVE', fecha: new Date(Y,M,25), titulo: 'Evento especial: noche acústica en sala pequeña', copy: 'Algo íntimo y diferente. El próximo viernes organizamos una noche acústica en formato reducido. Solo 150 plazas. Comenta "quiero" para recibir el enlace de compra antes que nadie 🎸', media: 'https://images.unsplash.com/photo-1524368535928-5b5e00ddc76b?w=900&q=80', tipo: 'imagen', canal: 'Facebook', estado: '' },
]
